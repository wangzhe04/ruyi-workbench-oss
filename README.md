...
| **8 套模板 · 9 种角色 · 340 项 e2e** | 内置 8 套多 Agent 工作流模板与 9 种节点角色。当前默认回归 333 项，另有 7 项需真实 API/桌面环境的 live probe 按需启用；另含 43 组 unit suite 与 16 组 ACC smoke |
...
├── dev-harness/                  验证脚手架(340 项 e2e,默认 333 项,Node 直跑)
├── docs/

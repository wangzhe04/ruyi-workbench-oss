...
| **8 套模板 · 9 种角色 · 243 项 e2e** | 内置 8 套多 Agent 工作流模板与 9 种节点角色。当前默认回归 236 项，另有 7 项需真实 API/桌面环境的 live probe 按需启用；另含 14 组 unit suite 与 16 组 ACC smoke |

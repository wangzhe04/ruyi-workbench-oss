...
| 2 | `01c-runtime-flags.js` | foundation | 34 | 0 | 0 |
...
| 29 | `10-context-governance.js` | orchestration | 133 | 72 | 14 |
...
| 52 | `14-main.js` | entrypoint | 1 | 532 | 36 |
...
| `10-context-governance.js` | `01c-runtime-flags.js` | backward | `evaporateBudgetBoundaryEnabled`, `historyReadDedupEnabled`, `observationRecallEnabled`, `sessionNotesEnabled`, `sessionNotesInjectEnabled`, `sessionNotesMergeEnabled`, `summaryEntityCheckEnabled`, `summaryFactTableCap`, `summaryFactTableEnabled`, `summaryPromptI18nEnabled`, `summaryRefineEnabled`, `summarySingleShotEnabled` |

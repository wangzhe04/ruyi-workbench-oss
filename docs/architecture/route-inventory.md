...
> 判定点 120(精确 103 / 前缀 12 / 正则 5),ROUTE_AUTH 108 条,生成于 2026-09-05T14:45:40.552Z。
...
| 方法 | 路径 | 形态 | auth | handler | 测试覆盖 |
|---|---|---|---|---|---|
| POST | `/api/steward/start` | exact | token self | 13g-steward.js:27 | steward-events.static.e2e.js, steward-inbox.e2e.js, steward-signals.e2e.js |
| POST | `/api/steward/stop` | exact | token self | 13g-steward.js:37 | steward-events.static.e2e.js, steward-inbox.e2e.js, steward-preroute.e2e.js |
| GET | `/api/steward/state` | exact | token self | 13g-steward.js:43 | steward-events.static.e2e.js, steward-inbox.e2e.js, steward-runner.e2e.js |
| GET | `/api/steward/inbox` | exact | token self | 13g-steward.js:55 | steward-events.static.e2e.js, steward-inbox.e2e.js |
| GET | `/api/steward/preroute` | exact | token self | 13g-steward.js:66 | steward-preroute.e2e.js |

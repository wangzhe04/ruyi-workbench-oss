...
> 判定点 127(精确 110 / 前缀 12 / 正则 5),ROUTE_AUTH 115 条,生成于 2026-09-06T13:26:45.305Z。
...
| GET | `/api/steward/arbiter` | exact | token self | 13h-steward-runner.js:1733 | steward-board.e2e.js, steward-board.static.e2e.js, steward-config-tools.e2e.js 等 5 件 |
| POST | `/api/steward/arbiter/prioritize` | exact | token self | 13h-steward-runner.js:1742 | steward-board.static.e2e.js, thread-arbiter.e2e.js |
| POST | `/api/steward/visit` | exact | token self | 13h-steward-runner.js:1756 | steward-conversation.e2e.js, steward-conversation.static.e2e.js, steward-runner.e2e.js 等 4 件 |
| POST | `/api/steward/act` | exact | token self | 13h-steward-runner.js:1768 | steward-conversation.e2e.js, steward-conversation.static.e2e.js, steward-runner.e2e.js 等 6 件 |
| POST | `/api/steward/message` | exact | token self | 13h-steward-runner.js:1780 | steward-conversation.static.e2e.js, steward-guardrails.e2e.js, steward-runner.e2e.js 等 4 件 |

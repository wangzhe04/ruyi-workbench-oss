...
| **Pretender** | `v3.0.0` | **如意 Ruyi Pretender 3.0** | 已立项（第56波评审 GO）；五层门 P1✅ / P2✅ / P3 工程✅（正式人因验证待办），P4 第87波 3.0.0 默认切换与发布待办 |
...
| 线 | 状态 | 依据 |
|---|---|---|
| **Escapade 发布线** | `v2.4.1` 已发布（2026-08-03，含 wave 86 硬化与 ACC v1.9.1） | `CHANGELOG.md`、git tag `v2.4.1` |
| **Pretender 3.0 交付线** | P1 Data & Contract Ready ✅；P2 Preview Ready ✅；P3 工程切片 81–85 全部收口 ✅，**正式外部受试者人因验证未执行**；P4 第86波硬化切片已交付，第87波 3.0.0 默认切换与发布待办 | `docs/PRETENDER-PLAN.md` v4、`docs/PRETENDER-METRICS.md` |
...
### 第87波 · Pretender P4 第二切片 — 3.0.0 默认切换与发布（待办）
...
### post-3.0 退出线（原第88波，不计入 3.0 交付工期）

...
| 27 | [第 115–117 波实施方案（工作台管家 Steward）](27-waves-115-117-steward.md) | **115 已交付（2026-09-05）**：原型 `docs/mockups/steward-shell.html` 经三轮走查定稿；拍板：两壳长期并存、线程单一权限四档取代三档自治、管家对话只保留本次、递话「输入即预判」。**116 已交付（2026-09-05 → 09-06，引擎侧，默认关）**：配置、收件箱三源轮询、26 个 `steward_*` 工具经命令核心、记忆完整版、线程级权限与只降不升、回合运行器与到访、事项跨会话升格、线程仲裁、设置三级分级、速查线程；串行全量 280/6/4，前向边 67 不变，逐片记录见 §11.6。**用户 2026-09-06 决定跑完 116 先停**。下一步 117 壳层（壳模式并存、avatar、话＋一行按钮、抽屉「它刚说／你可以说」、2.0 视窗、看板与「现在这一件」、设置、dogfood 门）；交办台停止独立演进 |
...
- 当前下一实施入口为 **27 号第 117 波管家壳层（117a 壳模式起）**；115 原型（2026-09-05）与 116 引擎侧（2026-09-06，默认关）均已出门，用户 2026-09-06 决定「跑完 116 先停」，117 尚未派单。执行序 117（119 可并行）→ 114 → 111 → 107 批准点。108–110、118、112a–c、113a/b、116 均已出门。

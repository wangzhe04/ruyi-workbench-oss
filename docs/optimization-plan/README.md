...
| 21 | [工具调用经济性校准与收敛](21-tool-call-economics-convergence.md) | E0 三层账本 shadow 已落地；E1 基线报表已上线；E2a 纯 read worker pool 已实施（开关默认关）、E2c 离线重放已上线（254 批 / pool vs serial -26% / >8 样本不足暂不 canary）；E2b 延后；E3–E5 规划冻结；HB360 对账门 blocked/deferred |

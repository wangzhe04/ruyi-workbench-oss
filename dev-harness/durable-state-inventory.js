...
const entries = [
  ...
  ['memory-usage','<data>/memory/_usage-v1.json','07-autonomy.js',"'_usage-v1.json'",'object / schema 1','atomicWriteJson','sanitize to empty entries','entry TTL/cap policy','process state','recompute from use','shared atomic write; domain sanitizer owns entries',SHARED],
  ['memory-meta','<data>/memory/**/meta.json','07-autonomy.js',"'meta.json'",'object / implicit v1','atomicWriteJson','invalid memory omitted','one per memory','registry scan','recreate from memory content','shared atomic metadata',SHARED],
  ['memory-import-marker','<data>/memory/.acc-memory-import-v1.json','07-autonomy.js',"'.acc-memory-import-v1.json'",'object / schema 1','atomicWriteJson','missing reruns idempotent import','one record','none','repeat idempotent import','shared atomic marker',SHARED],
  ['memory-proposals','<data>/memory/proposals/<session>.json','07-autonomy.js',"'proposals'",'object / schema 1','atomicWriteJson','invalid proposal ignored','one per session','none','regenerate proposal','shared atomic transient proposal',SHARED],
  ['memory-relations','<data>/memory/**/_relations.json','07-autonomy.js',"'_relations.json'",'array / domain normalized','atomicWriteJson','invalid rows filtered','domain bounded','none','re-propose relations','shared atomic domain state',SHARED],

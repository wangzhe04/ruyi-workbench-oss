...
const entries = [
  ...
  ['pretender-index','<data>/sessions/.pretender/projection-index.json','13e-pretender-index.js','PRETENDER_INDEX_FILE','object / schemaVersion 3','atomicWriteJson','invalid or older schema triggers full rebuild (116-5b: 2 -> 3, card gained displayTitle/brief)','one materialized projection','stamp-aware process cache','rebuild from sessions/runs/usage','fully regenerable materialized index',REBUILD],

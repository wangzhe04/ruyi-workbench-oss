...
try {
  ...
  }
  {
    ...
    // 129b 重钉:33 -> 36(三张只读清单);129d 重钉:36 -> 40(眼睛四件);129e 重钉:40 -> 41(改线程工作目录)。
    ok(stewardBody && stewardBody.tools.length === 41, `B7b 管家回合拿到全部 41 个 steward_*(按需装载对管家强制 full;got ${stewardBody && stewardBody.tools.length})`);

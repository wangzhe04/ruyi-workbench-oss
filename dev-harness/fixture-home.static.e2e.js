...
// 体验走查 #22:新增 dev-harness/static-revalidate.e2e.js(一处带 RUYI_HOME 的 spawn —— 起 serve 子进程;第一行已 require
// self-isolate-home,家目录是 mkdtemp 临时目录),161 -> 162 的来路就是它。
const RUYI_HOME_SPAWN_SITES = 162;

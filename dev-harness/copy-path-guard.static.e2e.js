...
const ALLOWED_CJK_CODE = Object.freeze({
  'chat-stream-runtime.js': {
    ...
    1051: '工具面板里的调试回显（模型=/权限=），不是常规用户文案：117q-B3a 登记，待另刀',
    1365: '「已按你的补充意见继续」提示：117q-B3a 登记，待另刀',
    1399: '正则字面量（匹配 SSE 文本用的「后台/异步/代理/任务/已启动/运行中」词表），不是渲染给用户的文案，不受本锁约束',
    1409: '子代理卡状态行「生成中 · N 字」：117q-B3a 登记，待另刀',
    1436: '子代理卡依赖标签「依赖 ...」：117q-B3a 登记，待另刀',
    1440: '子代理卡状态「执行中…」：117q-B3a 登记，待另刀',
    1465: '子代理卡重试状态「重试中 n/m」：117q-B3a 登记，待另刀',
    1498: '子代理卡「后台执行中」状态：117q-B3a 登记，待另刀',
    1499: '子代理卡「✓ 完成 · N 字结论」状态：117q-B3a 登记，待另刀',
  },
  'workbench.js': {

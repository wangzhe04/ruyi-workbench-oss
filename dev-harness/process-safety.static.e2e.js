...
const KILL_OWNERS = 257;   // codemod 250 件(含 run-all 的超时收尸)＋ kimi-acp-live-probe(手改)＋ 128e 新件 mcp-resource-config-mask ＋ 128d 公共夹具 lib/browser-fixture ＋ 128f-③ 新件 desktop-probe-status ＋ 128f-⑪ 新件 steward-deferred-permission ＋ 128f-⑬ 新件 cli-probe-stall ＋ 2026-09-21 新件 toolbox-discovery;unit/kill-own-tree.test.js 走绝对路径不计

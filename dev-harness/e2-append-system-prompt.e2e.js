...
(async () => {
  ...
  try {
    ...
    ok(flagVal.includes('<agent-team-mode>') && flagVal.includes('MUST call orchestrate_agents at least once'), 'Agent team request injects the aggressive orchestration policy into Claude CLI');
